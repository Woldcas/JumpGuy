...
public class UI_LevelSelection : MonoBehaviour
{
    ...
    {
        int levelsAmmount = SceneManager.sceneCountInBuildSettings - 1;

        for (int i = 1; i < levelsAmmount; i++)
        {
    ...
    private void LoadLevelsInfo()
    {
        ...
        levelsUnlocked = new bool[levelsAmmount];
        ...
        levelsUnlocked[1] = true; //The first level is always unlocked.
    }
}

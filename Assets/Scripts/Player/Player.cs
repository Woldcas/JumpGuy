...
public class Player : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        //FindAnyObjectByType<UI_JumpButton>().UpdatePlayersRef(this);
    ...
    private void CancelCoyoteJump() => coyoteJumpActivated = Time.time - 1; //bunun yerine 0 da yaz�labilir
    #endregion
